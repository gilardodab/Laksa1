...
public class Login extends AppCompatActivity {
    ...
    private void signup() {
        if(num_lay.getVisibility()==View.GONE){
            ...
            hello.setText("Halo Selamat Datang!");
            welcome.setVisibility(View.GONE);
            signintext.setText("Daftar Untuk Melanjutkan");
            ...
            if(un.equals("") || pass.equals("") || mail.equals("") || no.equals("")){
                ...
                alert.setText("Lengkapi Data Anda");
                alert.setVisibility(View.VISIBLE);

            }else
            if(!isEmailValid(mail)){
                alert.setText("Email Salah");
                alert.setVisibility(View.VISIBLE);

            }else
            if(no.length()>10 || no.length() <10){
                alert.setText("No Hp Salah");
                alert.setVisibility(View.VISIBLE);

            }else
            if(add.length()==0){
                alert.setText("Masukan Alamat");
                alert.setVisibility(View.VISIBLE);
            }else {
