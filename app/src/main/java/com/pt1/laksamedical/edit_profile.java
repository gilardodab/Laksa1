...
import static com.pt1.laksamedical.Login.REQUEST_CHECK_SETTING;
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(un.equals("") || mail.equals("") || pas.equals("") || no.equals("") || add.equals("")){
                    alert.setText("Isikan Data Anda!");
                    alert.setVisibility(View.VISIBLE);
                }else if(!Patterns.EMAIL_ADDRESS.matcher(mail).matches()){
                    alert.setText("Masukan Alamat Email anda!");
                    alert.setVisibility(View.VISIBLE);
                }
                else if(no.length()!=10){
                    alert.setText("Koreksi No Hp Anda ");
                    alert.setVisibility(View.VISIBLE);
                }
                else{
                    saveData();
